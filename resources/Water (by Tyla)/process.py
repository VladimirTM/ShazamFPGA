...
print("DATA", data)
print("PEAKS FOUND BY ALGO:", list(map(lambda x: x[0], try_find_peaks(data, 16))))

def check_pairs_are_is_in_data (pairs, data):
    for i in range (0, len(pairs)):
        if(data[pairs[i][0]] != pairs[i][1]):
            return False
    return True

print("THE VERILOG ALGORITHM IS:", check_pairs_are_is_in_data([[1, 0], [2, 0], [58, 12], [56, 20], [9, 6], [203, 10], [204, 1], [15, 10], [17, 13], [43, 20], [23, 28], [24, 14], [26, -1], [161, 2]], data));
